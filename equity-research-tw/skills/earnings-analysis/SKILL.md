...
description: 製作專業台股研究『財報更新報告』（8–12 頁），分析某一季結果：優於／低於預期、關鍵指標、更新預估與投資論點，含摘要表與圖表。觸發詞：財報更新、季報分析、Q1/Q2/Q3/Q4 結果、財報後報告。
---
...
- ✅ 季報 filing (with filing date and MOPS link)
- ✅ Earnings call transcript (with date)
- ✅ Investor presentation/supplemental materials (if available)
- ✅ Consensus estimates source (TWSE／FinMind/TWSE MCP（twstock）/etc. with date)
