...
- **SEC Filings (for public companies):**
  - Latest 年報: Business description, risk factors, MD&A, financials
  - Recent 季報: Quarterly updates
...
- Competitor websites and MOPS 公開資訊申報
...
2. **Gather MOPS 公開資訊申報 (if public)**
   - Download latest 年報 from 公開資訊觀測站（MOPS）
   - Download most recent 季報
...
2. **Research each competitor**
   ...
   - Review their MOPS 公開資訊申報 (if public)
