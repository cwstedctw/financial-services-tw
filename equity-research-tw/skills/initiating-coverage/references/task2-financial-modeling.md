...
- **Required**: Access to company financial data
  - For public companies: Latest 年報 and recent 季報 from 公開資訊觀測站（MOPS）
...
- [ ] Have access to 年報 filings (public company)?
...
1. **Download 年報 Filing**
   - Go to 公開資訊觀測站（MOPS） (https://www.sec.gov/edgar/searchedgar/companysearch.html)
...
7. **Document Sources and Notes**
   ...
   - Document:
     - 年報 filing date and fiscal year end
     - Any one-time items or adjustments noted
     - Non-T-IFRS vs T-IFRS differences
