...
description: 以 5 階段工作流程產出機構等級『首次評等』研究報告：(1)公司研究 (2)財務建模 (3)估值 (4)製圖 (5)報告組裝；任務 3–5 依賴前面任務。
---
...
- **Required**: Access to company financial data
  - For public companies: Latest 年報 from 公開資訊觀測站（MOPS）
...
- **Required**: External market data
  - Historical stock price data (Yahoo Finance, TWSE／FinMind, etc.)
