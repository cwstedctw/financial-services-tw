...
**2. Determine Cost of Equity (CAPM)**
   ...
   - Beta: [Company beta from TWSE／FinMind/TWSE MCP（twstock） or peer average]
...
**Data sources:**
- TWSE MCP（twstock）, CapitalIQ, TWSE／FinMind (preferred)
- Company 年報/季報 for actuals
...
Source: TWSE MCP（twstock）, company filings, [Analyst] estimates.
```
